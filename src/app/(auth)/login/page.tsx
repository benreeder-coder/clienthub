...
export const metadata: Metadata = {
  title: 'Sign In',
  description: 'Sign in to your ClientHub account',
}
    ...
    <GlassCard className="w-full">
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            type="button"
            className="inline-flex items-center justify-center gap-2 rounded-md border border-input bg-background/50 px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground"
          >
